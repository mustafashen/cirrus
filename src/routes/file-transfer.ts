...
import { bufferType } from "../lib/bufferType";
import { saveBuffer } from "../lib/fileOperations";



export const fileTransfer = {
  '/upload/image': async (req: IncomingMessage, res: ServerResponse<IncomingMessage>) => {
    try {
      if (req.method !== 'POST' && req.headers.multipart !== 'form-data') throw new Error('Method not allowed')
